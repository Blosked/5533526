  ...
  var CustomWidget = function () {
    ...
    this.callbacks = {
      ...
      init: _.bind(function () {
        ...
        window.addEventListener("load", function () {
          ...
          const element = document.querySelector(
            ".f5_regionphone-about-body-text .f5_regionphone-about-text-city"
          );
      ...
      settings: _.bind(function ($modal_body) {
        this.getTemplate("oferta", {}, function (template) {
          ...
          $modal_body
            .find(".widget_settings_block__item_field:visible")
            .last()
            .after(
              template.render({
                oferta: self.i18n("settings").oferta,
                oferta_error: self.i18n("settings").oferta_error,
              })
            ); // отрисовываем шаблон и добавляем в блок настроек виджета
          $modal_body
            .find('input[name="oferta_check"]')
      ...
      salesbotDesignerSettings: function ($body, rowTemplate, params) {
        return {
          exits: [
            {
              code: "success",
              title: self.i18n("salesbot").success_callback_title,
            },
